...
import { SiMongodb, SiTailwindcss, SiGraphql, SiTypescript, SiFirebase, SiDocker, SiRedux } from 'react-icons/si';
...
const Skills = () => {
    const skills = [
        ...
        { icon: <FaHtml5 className="text-7xl text-orange-500" />, label: 'HTML5' },
        { icon: <FaCss3Alt className="text-7xl text-blue-500" />, label: 'CSS3' },
